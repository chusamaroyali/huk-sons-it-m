        ...
        <div className="py-12 md:py-16 lg:py-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-12">
            ...
            <div className="lg:col-span-3 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div
                    className="text-body uppercase tracking-[0.04em]"
            ...
            <div className="lg:col-span-2">
              <h3 className="text-body mb-4 md:mb-6 text-sm md:text-base uppercase tracking-wider">Solutions</h3>
            ...
            <div className="lg:col-span-2">
              <h3 className="text-body mb-4 md:mb-6 text-sm md:text-base uppercase tracking-wider hidden md:block">More</h3>
              <ul className="space-y-3 text-body/60 text-sm">
            ...
            {/* Company Column */}
            <div className="lg:col-span-2">
              <h3 className="text-body mb-4 md:mb-6 text-sm md:text-base uppercase tracking-wider">Company</h3>
              <ul className="space-y-3 text-body/60 text-sm">
                <li>
                  <button
            ...
            <div className="lg:col-span-3">
              <h3 className="text-body mb-4 md:mb-6 text-sm md:text-base uppercase tracking-wider">Legal</h3>
              <ul className="space-y-3 text-body/60 text-sm">
                <li>
                  <button
                    onClick={() => handleNavigate('/legal')}
                    className="hover:text-primary transition-colors duration-200 inline-block font-medium"
                  >
                    Legal Center
                  </button>
                </li>
                <li>
                  <button
                    onClick={() => handleNavigate('/legal/sla')}
                    className="hover:text-primary transition-colors duration-200 inline-block"
                  >
                    SLA
                  </button>
                ...
                <li>
                  <button
                    onClick={() => handleNavigate('/legal/nda')}
                    className="hover:text-primary transition-colors duration-200 inline-block"
                  >
                    NDA Policy
                  </button>
                ...
                <li>
                  <button
                    onClick={() => handleNavigate('/legal/security')}
                    className="hover:text-primary transition-colors duration-200 inline-block"
                  >
                    Security
                  </button>
              ...
              <div className="relative overflow-hidden p-12 md:p-16 lg:p-20 bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-2 border-primary/20 rounded-3xl">
                <div className="text-center">
                  ...
                  <div className="mt-8 flex items-center justify-center gap-8 flex-wrap">
                    ...
                    <div className="w-px h-12 bg-body/10"></div>
                    <div className="text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            ...
            <div className="bg-body/5 border border-subtle rounded-2xl p-8">
              <h3 className="text-body mb-4 text-lg uppercase tracking-wider">Newsletter</h3>
            ...
            {/* Contact Info */}
            <div className="bg-body/5 border border-subtle rounded-2xl p-8">
              <h3 className="text-body mb-4 text-lg uppercase tracking-wider">Contact</h3>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 flex items-center justify-center text-primary flex-shrink-0 mt-0.5">
                    <span className="text-lg">📞</span>
                  </div>
                  <div>
                    <div className="text-xs text-body/50 mb-1">Phone</div>
                    <div className="text-primary">+92 (331) 44 11011</div>
                  </div>
                </div>
              </div>
            </div>
