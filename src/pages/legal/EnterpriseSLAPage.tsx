...
export function EnterpriseSLAPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-main transition-colors duration-300">
            <SEOHead
        title="Enterprise Service Level Agreement (SLA) | HUK SONS IT"
        description="Enterprise SLA terms for mission-critical services. 99.9% uptime guarantee, 24/7/365 support, and priority response times."
        keywords="enterprise SLA, premium support, 99.9% uptime, 24/7 support, priority response"
        canonical="https://huksonsit.com/legal/sla/enterprise"
      />
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              <Button
                ...
                variant="outline"
                className="mb-8 border-2 border-subtle hover:border-primary"
              >
                <ArrowLeft className="mr-2 w-4 h-4" />
                Back to SLA Overview
              </Button>

              <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-primary/20 to-primary/10 border border-primary/40 rounded-full mb-8">
                <Shield className="w-5 h-5 text-primary" />
                <span className="text-sm uppercase tracking-wider text-primary">Enterprise Service Level Agreement</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-body dark:text-white/70 max-w-3xl leading-relaxed mb-6">
                Premium service commitments with 24/7/365 support, dedicated resources, and guaranteed <span className="text-primary">99.9% uptime</span> for mission-critical enterprise operations.
              </p>

              <div className="p-4 bg-primary/5 border border-primary/20 rounded-lg max-w-3xl mb-8">
              ...
              {[
                ...
                >
                  <Card className={`p-6 text-center border-2 transition-all duration-300 min-h-[180px] flex flex-col justify-center ${
                    stat.highlight 
                      ? 'bg-gradient-to-br from-primary/10 to-transparent border-primary/30 hover:border-primary' 
                      : 'bg-card border-subtle hover:border-primary'
                  }`}>
      ...
      <section className="relative py-16 md:py-24">
        <div className="container-enterprise relative z-10">
          <div className="max-w-5xl mx-auto space-y-12">
            ...
            >
              <Card className="p-8 md:p-10 bg-gradient-to-br from-white to-primary/5 dark:from-white/[0.03] dark:to-primary/5 border-2 border-primary/20">
                ...
                <div className="space-y-4 text-body dark:text-white/80">
                  <p className="text-lg leading-relaxed">
                    HUK SONS IT guarantees <strong className="text-primary">99.9% uptime</strong> for all managed infrastructure and solutions covered under this Enterprise SLA—the highest tier commitment available.
                  </p>
                  ...
                  <div className="bg-primary/10 border border-primary/30 p-6 rounded-lg">
                    ...
                    <div className="space-y-2">
                      ...
                      <p><strong className="text-primary">Zero-downtime deployments:</strong> All updates deployed with rolling releases to maintain continuous availability</p>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mt-6">
                    <div className="bg-primary/10 border-2 border-primary/30 p-4 rounded-lg">
                      ...
                      <p className="text-2xl text-primary">~43 minutes/month</p>
                      <p className="text-sm text-muted-foreground dark:text-white/60 mt-1">Based on 99.9% uptime</p>
                    </div>
                    <div className="bg-primary/10 border-2 border-primary/30 p-4 rounded-lg">
                      <h4 className="text-lg text-heading dark:text-white mb-2">Planned Maintenance</h4>
                      <p className="text-2xl text-primary">2 hours/month</p>
                      <p className="text-sm text-muted-foreground dark:text-white/60 mt-1">Maximum allowed window</p>
                    </div>
                    <div className="bg-primary/10 border-2 border-primary/30 p-4 rounded-lg">
                      <h4 className="text-lg text-heading dark:text-white mb-2">Redundancy</h4>
                      <p className="text-2xl text-primary">Multi-AZ</p>
                      <p className="text-sm text-muted-foreground dark:text-white/60 mt-1">High availability architecture</p>
                    </div>
                  </div>
                </div>
              </Card>
            ...
            >
              <Card className="p-8 md:p-10 bg-card border-2 border-subtle">
                ...
                <p className="text-lg text-body dark:text-white/80 mb-6">
                  Enterprise SLA provides industry-leading response times measured from ticket creation to first qualified technical response, <strong className="text-primary">24/7/365</strong>.
                </p>
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-primary/10">
                        <th className="border-2 border-primary/20 p-4 text-left text-heading dark:text-white">Priority Level</th>
                        <th className="border-2 border-primary/20 p-4 text-left text-heading dark:text-white">Description</th>
                        <th className="border-2 border-primary/20 p-4 text-left text-heading dark:text-white">Response Time</th>
                        <th className="border-2 border-primary/20 p-4 text-left text-heading dark:text-white">Resolution Target</th>
                      </tr>
                    </thead>
                    <tbody className="text-body dark:text-white/80">
                      <tr className="bg-red-500/5">
                        ...
                        <td className="border-2 border-primary/20 p-4">Complete service outage, production down, critical data loss, security breach</td>
                        <td className="border-2 border-primary/20 p-4"><strong className="text-primary text-lg">&lt; 15 minutes</strong></td>
                        <td className="border-2 border-primary/20 p-4">4 hours</td>
                      </tr>
                      <tr className="bg-orange-500/5">
                        <td className="border-2 border-primary/20 p-4">
                          <span className="px-3 py-1 bg-orange-500/20 text-orange-600 dark:text-orange-400 rounded-full text-sm">P2 - High</span>
                        </td>
                        <td className="border-2 border-primary/20 p-4">Major functionality impaired, significant performance degradation affecting users</td>
                        <td className="border-2 border-primary/20 p-4"><strong className="text-primary text-lg">&lt; 1 hour</strong></td>
                        <td className="border-2 border-primary/20 p-4">8 hours</td>
                      </tr>
                      <tr className="bg-yellow-500/5">
                        <td className="border-2 border-primary/20 p-4">
                          <span className="px-3 py-1 bg-yellow-500/20 text-yellow-600 dark:text-yellow-400 rounded-full text-sm">P3 - Medium</span>
                        </td>
                        <td className="border-2 border-primary/20 p-4">Minor functionality affected, workaround available, limited user impact</td>
                        <td className="border-2 border-primary/20 p-4"><strong className="text-primary text-lg">&lt; 2 hours</strong></td>
                        <td className="border-2 border-primary/20 p-4">2 business days</td>
                      </tr>
                      <tr className="bg-blue-500/5">
                        <td className="border-2 border-primary/20 p-4">
                          <span className="px-3 py-1 bg-blue-500/20 text-blue-600 dark:text-blue-400 rounded-full text-sm">P4 - Low</span>
                        </td>
                        <td className="border-2 border-primary/20 p-4">General inquiries, feature requests, documentation, optimization</td>
                        <td className="border-2 border-primary/20 p-4"><strong className="text-primary text-lg">&lt; 4 hours</strong></td>
                        <td className="border-2 border-primary/20 p-4">5 business days</td>
                      </tr>
                    </tbody>
                  </table>
                </div>

                <div className="mt-6 bg-primary/10 border-2 border-primary/30 p-6 rounded-lg">
                  ...
                  <p className="text-body dark:text-white/80">
                    <strong className="text-primary">Dedicated Emergency Hotline:</strong> Direct phone line with senior engineers for P1/P2 incidents—no ticket queues, no waiting.
                  </p>
                </div>
              </Card>
            </motion.div>
            ...
            >
              <Card className="p-8 md:p-10 bg-card border-2 border-subtle">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div className="p-6 bg-gradient-to-br from-primary/10 to-transparent border-2 border-primary/20 rounded-lg">
                    <h3 className="text-xl text-heading dark:text-white mb-4 flex items-center gap-2">
                      <Users className="w-6 h-6 text-primary" />
                      Technical Account Manager (TAM)
                    </h3>
                    <div className="space-y-2 text-body dark:text-white/80">
                ...
                <div className="space-y-4">
                  <h3 className="text-xl text-heading dark:text-white mb-4">Premium Support Channels:</h3>
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="flex items-start gap-3 p-4 bg-muted/50 dark:bg-white/[0.02] rounded-lg">
                      <Phone className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                      <div>
                        <div className="text-heading dark:text-white mb-1">Emergency Hotline</div>
                        <div className="text-sm text-muted-foreground dark:text-white/60">P1/P2 incidents - direct to senior engineers</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-muted/50 dark:bg-white/[0.02] rounded-lg">
                      <Mail className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                      <div>
                        <div className="text-heading dark:text-white mb-1">Priority Email</div>
                        <div className="text-sm text-muted-foreground dark:text-white/60">Dedicated queue with guaranteed response</div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-muted/50 dark:bg-white/[0.02] rounded-lg">
                      <FileText className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                      <div>
                        <div className="text-heading dark:text-white mb-1">Enterprise Portal</div>
                        <div className="text-sm text-muted-foreground dark:text-white/60">Custom dashboard, reporting, analytics</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Card className="p-8 md:p-10 bg-card border-2 border-subtle">
                ...
                <div className="overflow-x-auto mb-6">
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-primary/10">
                        <th className="border-2 border-primary/20 p-4 text-left text-heading dark:text-white">Monthly Uptime Achieved</th>
                        <th className="border-2 border-primary/20 p-4 text-left text-heading dark:text-white">Service Credit</th>
                        <th className="border-2 border-primary/20 p-4 text-left text-heading dark:text-white">Additional Remedy</th>
                      </tr>
                    </thead>
                    <tbody className="text-body dark:text-white/80">
                      <tr>
                        <td className="border-2 border-primary/20 p-4">≥ 99.9% but &lt; 99.95%</td>
                        <td className="border-2 border-primary/20 p-4"><strong className="text-primary">10%</strong> of monthly fees</td>
                        <td className="border-2 border-primary/20 p-4">Root cause analysis report</td>
                      </tr>
                      <tr>
                        <td className="border-2 border-primary/20 p-4">≥ 99.5% but &lt; 99.9%</td>
                        <td className="border-2 border-primary/20 p-4"><strong className="text-primary">25%</strong> of monthly fees</td>
                        <td className="border-2 border-primary/20 p-4">+ Executive review meeting</td>
                      </tr>
                      <tr>
                        <td className="border-2 border-primary/20 p-4">≥ 99.0% but &lt; 99.5%</td>
                        <td className="border-2 border-primary/20 p-4"><strong className="text-primary">50%</strong> of monthly fees</td>
                        <td className="border-2 border-primary/20 p-4">+ Remediation plan + priority on roadmap</td>
                      </tr>
                      <tr>
                        <td className="border-2 border-primary/20 p-4">&lt; 99.0%</td>
                        <td className="border-2 border-primary/20 p-4"><strong className="text-primary">100%</strong> of monthly fees</td>
                        <td className="border-2 border-primary/20 p-4">+ Penalty-free contract termination option</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-primary/10 border-2 border-primary/30 p-6 rounded-lg space-y-3 text-body dark:text-white/80">
                    <h4 className="text-lg text-heading dark:text-white mb-3">Response Time Credits:</h4>
                  ...
                  <div className="bg-primary/10 border-2 border-primary/30 p-6 rounded-lg space-y-3 text-body dark:text-white/80">
                    <h4 className="text-lg text-heading dark:text-white mb-3">Credit Application:</h4>
            ...
            >
              <Card className="p-8 md:p-10 bg-card border-2 border-subtle">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  <div>
                    <h3 className="text-xl text-heading dark:text-white mb-4">Advanced Monitoring:</h3>
                  ...
                  <div>
                    <h3 className="text-xl text-heading dark:text-white mb-4">Incident Prevention:</h3>
                    <div className="space-y-3 text-body dark:text-white/80">
                ...
                <div className="p-6 bg-primary/10 border-2 border-primary/30 rounded-lg">
                  <h4 className="text-lg text-heading dark:text-white mb-3">Custom Reporting & Analytics:</h4>
                  <div className="grid md:grid-cols-3 gap-4 text-body dark:text-white/80">
                    <div>
                      <p className="text-primary mb-1">Real-Time Dashboard</p>
                      <p className="text-sm">Live infrastructure metrics, alerts, incident tracking</p>
                    </div>
                    <div>
                      <p className="text-primary mb-1">Weekly Reports</p>
                      <p className="text-sm">Performance trends, resource utilization, cost analysis</p>
                    </div>
                    <div>
                      <p className="text-primary mb-1">Monthly Executive Summary</p>
            ...
            >
              <Card className="p-8 md:p-10 bg-card border-2 border-subtle">
                ...
                <div className="mt-6 p-6 bg-primary/10 border-2 border-primary/30 rounded-lg">
                  <p className="text-body dark:text-white/80">
                    <strong className="text-primary">Note:</strong> Unlike Standard SLA, Enterprise clients receive proactive mitigation for most third-party risks through redundant providers, multi-region architecture, and advanced DDoS protection—significantly reducing exclusion scenarios.
                  </p>
                </div>
              </Card>
            </motion.div>
            ...
            >
              <Card className="p-8 md:p-10 bg-card border-2 border-subtle">
                <h2 className="text-3xl text-heading dark:text-white mb-6">7. Term, Modifications & Guarantees</h2>
                
                <div className="space-y-6 text-body dark:text-white/80">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-6 bg-muted/50 dark:bg-white/[0.02] rounded-lg">
                      <h4 className="text-lg text-heading dark:text-white mb-3">SLA Term</h4>
                    ...
                    <div className="p-6 bg-muted/50 dark:bg-white/[0.02] rounded-lg">
                      <h4 className="text-lg text-heading dark:text-white mb-3">Performance Guarantee</h4>
                    ...
                    <div className="p-6 bg-muted/50 dark:bg-white/[0.02] rounded-lg">
                      <h4 className="text-lg text-heading dark:text-white mb-3">Upgrade Path</h4>
        ...
        <div className="container-enterprise relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl text-heading dark:text-white mb-6">
              Ready for Enterprise-Grade <span className="text-primary">Commitment?</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Button
                ...
                className="bg-primary hover:bg-primary/90 text-heading px-10 py-6 text-lg"
              >
                Get Enterprise SLA
              </Button>
              <Button
